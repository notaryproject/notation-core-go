...
type Revocation interface {
	...
	Validate(certChain []*x509.Certificate, signingTime time.Time) []*base.CertRevocationResult
}
...
func (r *revocation) Validate(certChain []*x509.Certificate, signingTime time.Time) []*base.CertRevocationResult {
